<%@ Page Title="Leave Details" Language="C#" MasterPageFile="~/Project/Site1.Master" AutoEventWireup="true" CodeBehind="LeaveDetailsStaff.aspx.cs" Inherits="FYP.Project.LeaveDetailsStaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="profilePanel">
        ...
        <asp:Panel ID="LeavePanel" runat="server" CssClass="profileContentPanel mt-2 mb-2" ScrollBars="Auto">
            <label class="subtitle">Leave Details</label>

            <div class="form-group">
                <div class="rows">
                    <label class="column" style="margin-right: 2%">Leave ID</label>
                    <label class="column">Leave Application Date</label>
                </div>
                <div class="rows">
                    <asp:TextBox ID="txtLeaveID" runat="server" CssClass="form-control column" Enabled="False" Style="margin-right: 2%"></asp:TextBox>
                    <asp:TextBox ID="txtLeaveAppDate" runat="server" CssClass="form-control column" Enabled="False"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="rows">
                    <label class="column" style="margin-right: 2%">Leave From</label>
                    <label class="column">Leave To</label>
                </div>
                <div class="rows">
                    <asp:TextBox ID="txtLeaveFrom" runat="server" CssClass="form-control column" Enabled="False" Style="margin-right: 2%"></asp:TextBox>
                    <asp:TextBox ID="txtLeaveTo" runat="server" CssClass="form-control column" Enabled="False"></asp:TextBox>
                </div>
            </div>

            <div class="form-group">
                <div class="rows">
                    <label class="column" style="margin-right: 2%">Leave Type</label>
                    <label class="column">Total Day</label>
                </div>
                <div class="rows">
                    <asp:TextBox ID="txtLeaveType" runat="server" CssClass="form-control column" Enabled="False" Style="margin-right: 2%"></asp:TextBox>
                    <asp:TextBox ID="txtTotalDay" runat="server" CssClass="form-control column" Enabled="False"></asp:TextBox>
                </div>
            </div>

            <div class="form-group">
                <label>Leave Reason</label>
                <asp:TextBox ID="txtLeaveReason" runat="server" CssClass="form-control" Text="" Enabled="False" TextMode="MultiLine"></asp:TextBox>
            </div>

            <div class="form-group">
                <div class="rows">
                    <label class="column" style="margin-right: 2%">Leave Status</label>
                    <label class="column">Reject Reason</label>
                </div>
                <div class="rows">
                    <asp:TextBox ID="txtStatus" runat="server" CssClass="form-control column" Enabled="False" Style="margin-right: 2%"></asp:TextBox>
                    <asp:TextBox ID="txtRejectReason" runat="server" CssClass="form-control column" Enabled="False"></asp:TextBox>
                </div>
            </div>
